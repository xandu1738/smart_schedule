...
import { useSaveDepartmentMutation } from "../../helpers/redux/slices/extendedApis/departmentsApi";

const AddDepartment = ({ setShowDialog, setRefetch }) => {
  const [saveDepartment, { isLoading }] = useSaveDepartmentMutation();
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4">
            <div className="flex flex-col justify-center items-center">
              ...
              <Button
                ...
                buttonName={isLoading ? <Spinner /> : "Save"}
                disabled={isLoading}
              />
            </div>
          </form>
